...
![Screenshot of the Elite 3D title screen](https://elite.bbcelite.com/images/github/elite-3d-title.png)
...
![Screenshot of Elite 3D](https://elite.bbcelite.com/images/github/elite-3d-boxart.png)
...
* [Building Elite 3D from the source](#building-elite-3d-from-the-source)
...
The reason for this is that Elite 3D is intertwined with the original source code for Elite, and the original source code is copyright. The whole site is therefore covered by default copyright law, to ensure that this copyright is respected.
...
I hope you enjoy exploring the inner workings of Elite 3D as much as I've enjoyed writing it.
...
## Building Elite 3D from the source

Builds are supported for both Windows and Mac/Linux systems. In all cases the build process is defined in the `Makefile` provided.

### Requirements

You will need the following to build Elite 3D from the source:
...
Let's look at how to build Elite 3D from the source.
...
will produce a file called `elite-3d.ssd` in the `5-compiled-game-discs` folder that contains Elite 3D, which you can then load into an emulator, or into a real BBC Micro using a device like a Gotek.
...
By default the build process will create a typical Elite game disc with a standard commander. There are two arguments you can pass to the build to change how it works. They are:
...
will build Elite 3D with a maxed-out commander.
...
-----------------------------------------------------------
db87951a    480  db87951a    480   Yes   ANAGLYPH.bin
dca785ab    788  dca785ab    788   Yes   ELITE.bin
77838a55   5769  77838a55   5769   Yes   ELITEa.bin
c42700ea   2194  c42700ea   2194   Yes   ELTA.bin
71311979   3171  71311979   3171   Yes   ELTB.bin
5c6e536d   3315  5c6e536d   3315   Yes   ELTC.bin
17550cf5   3352  17550cf5   3352   Yes   ELTD.bin
636afec2   2797  636afec2   2797   Yes   ELTE.bin
a4f5a913   4022  a4f5a913   4022   Yes   ELTF.bin
2dedb3bc   3783  2dedb3bc   3783   Yes   ELTG.bin
0c44ebed   1357  0c44ebed   1357   Yes   ELTH.bin
eb7defcb   1442  eb7defcb   1442   Yes   ELTI.bin
be773116   3728  be773116   3728   Yes   ELTJ.bin
e152ecbf   7238  e152ecbf   7238   Yes   I.CODE.bin
aeac68cb  40897  aeac68cb  40897   Yes   P.CODE.bin
de3c410a  40417  de3c410a  40417   Yes   P.CODE.unprot.bin
a8aea58b  10220  a8aea58b  10220   Yes   SHIPS.bin
